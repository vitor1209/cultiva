    ...
    return (
        <Box width="100%" display="flex" flexDirection="column" alignItems="center" bgcolor={"#fff9dfff"}>
            ...
            >
                ...
                <Typography mt={-2} sx={{width: "80%", marginLeft: "10%"}} fontSize={{ xs: "0.95rem", md: "1.1rem" }}>
            ...
            >
                ...
                >
                    ...
                    />
                    <Box>
                        <Typography fontSize={{ xs: "0.95rem", md: "1.1rem"  }} mb={1}>
                        ...
                        <Typography fontSize={{ xs: "0.95rem", md: "1.1rem" }}>
