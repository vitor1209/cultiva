// import { Container, IconButton, Stack, MenuItem, Typography } from "@mui/material";
...
// import * as styled from "../Cadastrar/CadastrarProdutoPage.styled.ts";
...
//   const { control, onSubmit, isLoading } = useEditarProduto(Number(id));

//   return (
//     <Container disableGutters maxWidth={false} sx={{ backgroundColor: "#fff8f0", textAlign: "center", marginTop: 8, padding: 0 }}>
//       <Header
//         end={<IconButton aria-label="perfil" size="large"><UserRound /></IconButton>}
...
//           <styled.BoxFoto>
//             <InputImagem name="ImagemProduto" label="Editar Produto:" height={40} width={45} />
//           </styled.BoxFoto>
...
//                 <Typography className="input-label" variant="subtitle1" color="#0A0A0A" fontWeight={500}>
//                   Unidade de medida:
//                 </Typography>
...
//               <Button variante="ButtonGray" sx={{ width: "48%" }} tamanho="md" type="button" onClick={() => history.back()}>Cancelar</Button>
//               <Button sx={{ width: "48%" }} tamanho="md" type="submit" disabled={isLoading}>
